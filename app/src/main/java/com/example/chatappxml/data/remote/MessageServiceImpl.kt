...
import com.example.chatappxml.data.remote.dto.MessagesPageRequest
...
class MessageServiceImpl(
    ...
    override suspend fun refreshChatMessages(query: Long): List<MessageDto> {
        return try {
    ...
    override suspend fun getNewChatMessages(lastMessage: Long, query: Long): List<MessageDto> {
    ...
    override suspend fun getOldChatMessages(lastMessage: Long, query: Long): List<MessageDto> {
        return try {
